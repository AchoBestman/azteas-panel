...
# ============================================================
# Lance la restauration Piler en arrière-plan via screen
...
#   tail -f /var/log/piler-restore.log
#
# Reprendre la session interactive :
#   screen -r piler-restore
# ============================================================

SNAPSHOT="${1:-latest}"
SESSION="piler-restore"
...
echo "==> Lancement de la restauration en arrière-plan..."
